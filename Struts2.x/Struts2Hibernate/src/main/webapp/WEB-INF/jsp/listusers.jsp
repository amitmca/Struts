			...
			<tbody>
				<s:iterator value="users">
					<tr>
						...
						<td align='center'><a
							href="/Struts2Hibernate/editUserAction.action?userid=<s:property value = 'user_id'/>"><img
								src="<c:url value='/resources/mytheme/images/b_edit.png'/>" /></a>&nbsp;&nbsp;<a
							href="/Struts2Hibernate/deleteUserAction.action?userid=<s:property value = 'user_id'/>"><img
