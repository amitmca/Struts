...
<script type="text/javascript"	src="<c:url value='/resources/mytheme/js/customalert.js'/>"></script>
<link rel="stylesheet" type="text/css" href="<c:url value='/resources/mytheme/css/customalert.css'/>" />
...
<body id="dt_example">
	...
	<div class="full_w">
		<s:form action="updateUserAction" namespace="/" method="post"
			name="strutsForm">
			<div class="element">
				<s:hidden name="user.user_id" value="%{editusers.user_id}" />
			</div>

			<div class="element">
				<s:textfield name="user.firstName" size="30" maxlength="50"
					key="label.firstName" value="%{editusers.firstName}" />
			</div>

			<div class="element">
				<s:textfield name="user.lastName" size="30" maxlength="50"
					key="label.lastName" value="%{editusers.lastName}" />
			</div>

			<div class="element">
				<s:textfield name="user.username" size="30" maxlength="50"
					key="label.username" value="%{editusers.username}" />
			</div>

			<div class="element">
				<s:password name="user.password" size="30" maxlength="50"
					key="label.password" value="%{editusers.password}" />
			</div>
			...
			<div class="element">
				<s:textfield name="user.emailId" size="30" maxlength="50"
